...
namespace Drupal\example_field\Plugin\Field\FieldType;
...
/**
 * Defines the 'example_fieldtype' field type.
 *
 * @FieldType(
 *   id = "example_fieldtype",
 *   label = @Translation("ExampleFieldType"),
 *   category = @Translation("General"),
 *   default_widget = {
 *     "string_textfield",
 *     "example_field_widget",
 *   },
 *   default_formatter={
 *     "string",
 *     "example_field_examplefieldformattor",
 *   }
 * )
 *
 * @DCG
 ...
 */
class ExampleFieldtypeItem extends FieldItemBase {
